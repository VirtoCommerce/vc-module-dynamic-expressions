...
"%MSBUILD_PATH%" "%SOURCE_DIR%\VirtoCommerce.DynamicExpressionsModule.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"

nuget pack "%SOURCE_DIR%\VirtoCommerce.DynamicExpressionsModule.Data\VirtoCommerce.DynamicExpressionsModule.Data.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
